...
export default function Banner() {
  ...
  return (
    <div className="h-72 sm:h-52  w-full bg-ikea-orange dark:bg-dark-black dark:sm:bg-dark-black sm:bg-ikea-blue bg-cover relative bg-[url('/hero-bg.png')] lg:bg-[url('/hero-bg-lg.png')]">
      ...
      <div className="h-40 relative text-white flex flex-col items-center justify-end ">
        ...
        <div className="font-bold text-3xl mt-1">{CategoryMap[category as RoomType]}</div>
        <div className="text-white text-xs mt-8">数据来自宜家官网 | 每周更新</div>
      </div>
    </div>
  );
}
