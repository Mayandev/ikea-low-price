...
export default function Banner() {
  ...
  return (
    <div className="h-72 sm:h-44  w-full bg-ikea-orange dark:bg-dark-black dark:sm:bg-dark-black sm:bg-ikea-blue bg-cover relative bg-[url('/hero-bg.png')] lg:bg-[url('/hero-bg-lg.png')]">
